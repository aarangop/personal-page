...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(AppBar, "AppBar").$$render(
    ...
    {
      trail: () => {
        return `${validate_component(Icon, "Icon").$$render($$result, { icon: "bi:github" }, {}, {})} ${validate_component(Icon, "Icon").$$render($$result, { icon: "bi:linkedin" }, {}, {})} ${validate_component(LightSwitch, "LightSwitch").$$render($$result, {}, {}, {})} `;
      },
      default: () => {
