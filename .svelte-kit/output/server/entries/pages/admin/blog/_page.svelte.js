...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  return `<section class="px-16 py-4 flex flex-col space-y-4 grow"><h2 class="h2 text-2xl grow-0" data-svelte-h="svelte-xkwqty">Blogs Admin Page</h2> <div class="flex flex-col space-y-2 grow"><div class="flex flex-col grow">${each(data.blogPosts, (blogPost) => {
